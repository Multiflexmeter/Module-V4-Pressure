...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = ONE_WIRE1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_TIM2;
    HAL_GPIO_Init(ONE_WIRE1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(ONE_WIRE1_GPIO_Port, ONE_WIRE1_Pin);
  ...
  /* USER CODE END TIM21_MspDeInit 0 */
    ...
    PB6     ------> TIM21_CH1
    */
    HAL_GPIO_DeInit(ONE_WIRE2_GPIO_Port, ONE_WIRE2_Pin);
